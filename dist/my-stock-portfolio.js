(function (global, factory) {
    ...
    (global = global || self, global.MyStockPortfolio = factory());
}(this, (function () { 'use strict';

    class MyStockPortfolio {
      get portfolioDistribution() {
        return this._portfolioDistribution;
      }

      set portfolioDistribution(distribution) {
        this._portfolioDistribution = distribution;
      }
      ...
      totalValueInvested() {
        ...
        const totalValueInvested = this.positions.reduce((accumulator, position) => {
          return typeof accumulator === 'number' ? this.normalizeToNumber(accumulator + position.totalValue) : this.normalizeToNumber(accumulator.totalValue + position.totalValue);
        });
